...
| `mermail-smart-digest` | Build a prioritized, read-only daily inbox briefing (rank by sender, recency, and signal) without composing, sending, moving, or deleting mail |
